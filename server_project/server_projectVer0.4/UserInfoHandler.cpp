...
private:
    ...
    void moveUserData(User unapproved_users, UserInfo approved_users, string lvl);
}
...
void UserInfoHandler::moveUserDatavoid moveUserData(User unapproved_users, string id, string lvl)
{
